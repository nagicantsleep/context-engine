...
try {
  ...
  console.error(
    ...
    `Try reinstalling: npm install -g context-engine`
  )
  process.exit(1)
}
...
// `npx context-engine@latest` cannot replace the cached binary and npm
